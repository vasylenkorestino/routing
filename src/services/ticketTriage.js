...
async function createRouteLog(conn, ticket, decision, matchedRoute, parentLogId = null) {
  ...
  try {
    ...
    return {
      ...
      routeServiceDate: matchedRoute?.serviceDate || decision.suggestedDate || null,
      routeRecordType: matchedRoute?.recordTypeName || null,
      suggestedDate: decision.suggestedDate || null,
